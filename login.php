...
if($_SESSION['user']!=""){
    $name = $_SESSION['user'];
    header("Location: /members.php?view=$name");
    exit;
}
if($verify=="yes"){
    if (isset($_POST['user']))
...
//                //确保重定向后，后续代码不会被执行
//                exit;
                exit("<div class='center'>You are now logged in. Please
             <a data-transition='slide' href='members.php?view=$user'>click here</a>to continue.</div></div></body></html>我草！");
            }
        }
    }
}
...
echo <<<_END
      <form method='post' action='login.php'>
        ...
        <div data-role='fieldcontain'>
          ...
          <button data-transition='slide' onclick="verify()">Login</button>
        </div>
